  ...
  return (
    <div className="space-y-8" id="rooms">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-black text-gray-900 tracking-tight">Available Rooms</h2>
        <span className="text-sm font-bold text-gray-400 uppercase tracking-widest">{rooms.length} room types</span>
      </div>
          ...
          <div key={room.id} className="bg-white rounded-3xl border border-gray-100 p-8 flex flex-col lg:flex-row gap-8 hover:shadow-xl transition-all duration-300 group">
            ...
            <div className="lg:w-72 flex flex-col items-center justify-center p-8 bg-blue-50/30 rounded-3xl border border-blue-100/30 text-center space-y-6">
              <div className="flex flex-col items-end">
                <div className="text-2xl font-black text-blue-600">${room.price_per_night}</div>
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-4">per night</p>
